...
# ./tangerine-chequing.bash tangerine-chequing.csv "2023-12-20"
...
# (".*"),(.*),(.*),(.*),(.*)
# # with
# # $1,$3,"$5","from Tangerine Chequing"
sed -E 's/(".*"),(.*),(.*),(.*),(.*)/\1,"\3","\5","from Tangerine Chequing"/g' $filename >$filename.tmp && mv $filename.tmp $filename
