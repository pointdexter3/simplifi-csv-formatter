...
# ./tangerine-savings.bash tangerine-savings.csv "2023-12-20"
...
# (".*"),(.*),(.*),(.*),(.*)
# # with
# # $1,$3,"$5","from Tangerine Savings"
sed -E 's/(".*"),(.*),(.*),(.*),(.*)/\1,"\3","\5","from Tangerine Savings"/g' $filename >$filename.tmp && mv $filename.tmp $filename
